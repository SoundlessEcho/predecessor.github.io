    ...
    wrap.innerHTML = data.releases.map(r => `
      <div class="card">
        ...
        <div class="kv">
          ...
          <span>SHA256: ${r.sha256.slice(0,12)}…</span>
        </div>
        <p><a class="btn primary" href="${r.url}" download>Download</a>
           <a class="btn ghost" href="${r.changelog}">Changelog</a></p>
      </div>
    `).join('');
  }catch(e){
...
(function(){
  ...
  img.style.maxWidth = '92vw'; img.style.maxHeight = '92vh'; img.style.border='1px solid #103a25'; img.style.borderRadius='12px';
